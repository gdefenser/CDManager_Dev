...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:EntityDataSource ID="edsMyApply" runat="server" ConnectionString="name=CDManagerDevEntities"
        ...
        Where="it.DZTM=@DZTM" EntityTypeFilter="" Select="it.Book.ZTM,it.Book.CBS,it.Book.ZRZ,it.Book.FLTM,it.ISBN,it.SQSJ,it.SQBH"
    ...
    <center>
        <asp:UpdatePanel ID="upMyApply" runat="server">
            <ContentTemplate>
                <asp:ListView ID="lvMyApply" runat="server" DataKeyNames="ISBN" DataSourceID="edsMyApply" OnItemDataBound="lvMyApply_ItemDataBound">
