        ...
        <asp:UpdatePanel ID="upCD" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="gvBook" runat="server" CellPadding="4" DataSourceID="edsBook"
                    ...
                    BorderStyle="Solid" BorderWidth="1px" DataKeyNames="ISBN"
                ...
                <hr />
                <asp:EntityDataSource ID="edsCD" runat="server" ConnectionString="name=CDManagerDevEntities" DefaultContainerName="CDManagerDevEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="CD" EntityTypeFilter="" Select="" Where="it.ISBN=@ISBN">
                    <WhereParameters>
                        <asp:QueryStringParameter Name="ISBN" QueryStringField="ISBN" DbType="String" />
                    </WhereParameters>
                </asp:EntityDataSource>
