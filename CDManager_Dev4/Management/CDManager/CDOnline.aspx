...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:EntityDataSource ID="edsBook" runat="server" ConnectionString="name=CDManagerDevEntities"
        DefaultContainerName="CDManagerDevEntities" EnableFlattening="False" CommandText="select b.ZTM,b.ISBN from Book as b where b.ISBN in (select value distinct cd.ISBN from CD as cd where cd.ZXZT=1)" OrderBy="it.ISBN">
