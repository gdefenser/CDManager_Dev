<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Masters/Management.Master" AutoEventWireup="true" CodeBehind="ReceivedMessage.aspx.cs" Inherits="CDManager_Dev4.Management.Message.ReceivedMessage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:EntityDataSource ID="edsAdmin" runat="server" ConnectionString="name=CDManagerDevEntities" DefaultContainerName="CDManagerDevEntities"
        ...
        Where="it.SXRTM=@SXRTM and it.YHLX='admin'">
        <WhereParameters>
                ...
                <asp:ListView ID="lvAdmin" runat="server" DataSourceID="edsAdmin">
                    ...
                    <ItemTemplate>
                        <tr style="">
                            <th>发信人:</th>
                            <td>
                                <asp:HyperLink ID="linkFSRTM" runat="server" Text='<%# Eval("FSRTM") %>' NavigateUrl='<%# Eval("FSRTM","~/Management/Message/MessageDialog.aspx?TM={0}") %>'></asp:HyperLink>
                            </td>
                            <th>发送时间:</th>
                            <td>
                        ...
                        <tr>
                            <th colspan="5" bgcolor="#5381AC" style="color: #FFFFFF">最新消息</th></tr>
                        <tr>
