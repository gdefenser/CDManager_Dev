        ...
        <asp:Panel ID="panelAdmin" runat="server" Visible="false">
            ...
            <asp:UpdatePanel ID="upAdmin" runat="server">
                <ContentTemplate>
                    ...
                    <hr />
                    <h3>光盘上传记录</h3>
                    <asp:EntityDataSource ID="edsUploadLog" runat="server" ConnectionString="name=CDManagerDevEntities" DefaultContainerName="CDManagerDevEntities" EnableFlattening="False" EntitySetName="UploadLog" Where="it.CZYTM=@CZYTM" Select="it.CD.CDMC,it.CD.Book.ZTM,it.CD.ISBN,it.SCSJ,it.CZYTM,it.SCBH,it.IP" OrderBy="it.SCBH">
                        <WhereParameters>
