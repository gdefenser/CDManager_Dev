        ...
        <asp:Panel ID="panelReader" runat="server" Visible="false">
            ...
            <asp:UpdatePanel ID="upReader" runat="server">
                <ContentTemplate>
                    ...
                    <br />
                    <asp:EntityDataSource ID="edsApply" runat="server" ConnectionString="name=CDManagerDevEntities" DefaultContainerName="CDManagerDevEntities" EnableFlattening="False" EntitySetName="ApplyLog" EntityTypeFilter="" OrderBy="it.SQSJ" Select="it.Book.ZTM,it.Book.CBS,it.Book.ZRZ,it.ISBN,it.SQSJ,it.SQBH,it.IP" Where="it.DZTM=@DZTM">
                        <WhereParameters>
                    ...
                    <asp:EntityDataSource ID="edsDownload" runat="server" ConnectionString="name=CDManagerDevEntities"
                        ...
                        Where="it.CZYTM=@CZYTM" Select="it.CD.CDMC,it.CD.Book.ZTM,it.CD.Book.CBS,it.CD.Book.ZRZ,it.CDID,it.CD.ISBN,it.XZSJ,it.CZYTM,it.XZBH,it.IP"
                        OrderBy="it.XZSJ">
                        <WhereParameters>
