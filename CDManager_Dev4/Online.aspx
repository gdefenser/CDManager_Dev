<%@ Page Title="在线资源目录" Language="C#" MasterPageFile="~/Resources/Masters/NoticeShower.Master"
    AutoEventWireup="true" CodeBehind="Online.aspx.cs" Inherits="CDManager_Dev4.Online" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    在线资源目录
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:SqlDataSource ID="sdsOnline" runat="server" ConnectionString="<%$ ConnectionStrings:CDManagerDevConnectionString %>" 
        SelectCommand="SELECT b.ZTM,b.ISBN,b.CBS,b.ZRZ,b.FLTM,count(d.CDID) as mycount from CD as cd 
left join DownloadLog as d on d.CDID=cd.CDID
join Book as b on 
b.ISBN=cd.ISBN and cd.ZXZT=1
group by b.ZTM,b.ISBN,b.CBS,b.ZRZ,b.FLTM order by mycount desc"></asp:SqlDataSource>
    <center style="height: 700px; margin-top: 50px;">
        ...
        <asp:UpdatePanel ID="upBook" runat="server">
            <ContentTemplate>
                <asp:ListView ID="lvBook" runat="server" DataKeyNames="ISBN" DataSourceID="sdsOnline" OnItemDataBound="lvBook_ItemDataBound">
