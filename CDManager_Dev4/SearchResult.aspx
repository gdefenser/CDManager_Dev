    ...
    <div id="search_result">
        <asp:UpdatePanel ID="upSearchResult" runat="server">
            <ContentTemplate>
                ...
                <asp:ListView ID="listBook" runat="server" DataKeyNames="ISBN" DataSourceID="edsBook" Visible="false"
                    ...
                    <ItemTemplate>
                        <table width="100%">
                            <tr>
                                <td width="100%">
                                    <div>
                                        <asp:HyperLink ID="linkCDMC" runat="server" NavigateUrl='<%# Eval("ISBN","~/BookDetail.aspx?ISBN={0}") %>' Font-Size="12pt" Font-Bold="True"><%# Eval("CDMC") %></asp:HyperLink>&nbsp;&nbsp;&nbsp;<asp:Label ID="lblCDXH" runat="server" Text='<%# Eval("CDXH") %>' Font-Bold="True" />
                                    </div>
                                    <br />
                                    [<asp:Label ID="lblISBN" runat="server" Text='<%# Eval("ISBN") %>' />]
                                    ...
                                    <div style="float: right; margin-top: -38px">
                                        ...
                                        <center style="padding: 2px; border: 1px solid #999999; margin-top: 5px;">
                                            <asp:Panel ID="panelApply" runat="server" Visible="False">
                                                <asp:Button ID="btnApplySubmit" runat="server" Text="提交申请" Visible="false" CommandArgument='<%# Eval("ISBN") %>' OnCommand="btnApplySubmit_Command" />
                                            ...
                                            <asp:Panel ID="panelUpload" runat="server" Visible="False" Font-Bold="True">
                                                还没有上传该光盘资源,<asp:HyperLink ID="linkUpload" runat="server" NavigateUrl='<%# Eval("ISBN","~/Management/CDManager/CDDetail.aspx?ISBN={0}") %>'>点击上传</asp:HyperLink>
                                            </asp:Panel>
