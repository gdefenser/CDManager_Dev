<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/Masters/Front.Master" AutoEventWireup="true" CodeBehind="TimeSpanTooShort.aspx.cs" Inherits="CDManager_Dev4.TimeSpanTooShort" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center style="padding-top: 250px; padding-bottom: 250px">
        <h2 style="color: #990000">很抱歉,你只能在5秒内检索一次图书或光盘<br />
