...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:EntityDataSource ID="edsMyDownload" runat="server" ConnectionString="name=CDManagerDevEntities"
        ...
        Where="it.CZYTM=@CZYTM" Select="it.CD.Book.BookID,it.CD.CDMC,it.CD.Book.ZTM,it.CD.Book.CBS,it.CD.Book.ZRZ,it.CD.Book.FLTM,it.CD.Book.ISBN,it.XZSJ,it.CZYTM"
    ...
    <center>
        <asp:UpdatePanel ID="upMyDownload" runat="server">
            ...
            <ContentTemplate>
                ...
                <asp:ListView ID="lvMyDownload" runat="server" DataKeyNames="BookID" DataSourceID="edsMyDownload" OnItemDataBound="lvMyDownload_ItemDataBound">
