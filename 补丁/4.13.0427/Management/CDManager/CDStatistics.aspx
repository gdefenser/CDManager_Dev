    ...
    <center>
        <table class="statistics" cellspacing="0" cellpadding="4">
            ...
            <tr>
                ...
                <td>
                    <asp:HyperLink ID="linkOnlineCount" runat="server"></asp:HyperLink>
                </td>
                <td>
                ...
                <td>
                    <asp:HyperLink ID="linkDownload" runat="server" NavigateUrl="~/Management/CDManager/DownloadSearch.aspx"></asp:HyperLink></td>
                <td>
                    <asp:Label ID="lblMouthApply" runat="server"></asp:Label></td>
                <td>
                    <asp:HyperLink ID="linkMouthDownload" runat="server"></asp:HyperLink>
                </td>
            </tr>
        </table>
        <hr />
