...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <table id="backtable">
            ...
            <tr>
                <td class="backitemtitle">清空登录用户缓存
                    
                </td>
            </tr>
            <tr>
                <td>现已保存登录用户缓存:<asp:Label ID="lblCatch" runat="server"></asp:Label><asp:Button ID="btnCatch" runat="server" Text=" 清 空 " OnClick="btnCatch_Click" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="lblFTP" runat="server" Text="FTP已关闭,请检查相关服务器是否已正确运行"  ForeColor="#990000" Font-Bold="True" Visible="false"></asp:Label>
                </td>
            </tr>
            <tr>
