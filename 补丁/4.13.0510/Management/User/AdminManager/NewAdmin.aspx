...
<%@ Register Src="../../../Resources/UserControl/CalendarExtender.ascx" TagName="CalendarExtender"
    TagPrefix="uc1" %>
<%@ Register Src="~/Resources/UserControl/CalendarExtender.ascx" TagPrefix="uc2" TagName="CalendarExtender" %>
    ...
    <center>
        <table class="input">
            ...
            <tr>
                ...
                <td>
                    <uc2:CalendarExtender runat="server" ID="CalendarExtenderYXRQ" /><br />
