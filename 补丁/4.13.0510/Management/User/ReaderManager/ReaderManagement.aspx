    ...
    <asp:UpdatePanel ID="upReader" runat="server">
        <ContentTemplate>
            <center style="font-size: small">
                ...
                <hr />
                 <asp:Button ID="btnReaderDelete" runat="server" OnClick="btnReaderDelete_Click" Visible="false" /><br />
                <asp:Button ID="btnDelete" runat="server" Text="注销本列表读者" Visible="false" OnClick="btnDelete_Click" />
